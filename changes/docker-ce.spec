...
Patch0: small-ipv4-networks.patch
...
%description
THIS VERSION OF DOCKER IS PATCHED.  See
https://github.com/moby/libnetwork/pull/2624 for more information.
...
ln -s ${RPM_BUILD_DIR}/src/engine %{gopath}/src/github.com/docker/docker
